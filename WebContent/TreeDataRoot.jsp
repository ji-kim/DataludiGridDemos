...
<script>
    $(document).ready(function() {
        ...
        $('#btnSetRoot').click(function() {
            var dataRoot = treeMain.focusedDataRow();
            treeMain.setDataRoot(dataRoot);
        });
        $('#btnShowParent').click(function() {
            var dataRoot = treeMain.dataRoot();
            if (dataRoot) {
                treeMain.setDataRoot(dataRoot.parent());
            }
        });
        $('#btnReset').click(function() {
            treeMain.setDataRoot(null);
        });
    });
</script>
</head>
<body>
    <h3>Tree Data Root</h3>
    <div>
        <button id="btnSetRoot">Set DataRoot</button>
        <br>
        <button id="btnShowParent">Show Parent</button>
        <br>
