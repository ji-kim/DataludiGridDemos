...
<body>
    <h3>Style Region - Grid</h3>
    <div id="container" style="height: 550px; width: 740px; min-width: 500px"></div>
    <div>
        <span id="rowCount" style="">0</span> rows.
    </div>
    <div>
        <button id="btnStyle1">Styles1</button>
        <button id="btnStyle2">Styles2</button>
        <button id="btnClearStyle">Clear Styles</button>
    </div>
</body>
</html>