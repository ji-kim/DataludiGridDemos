...
<script>
    $(document).ready(function() {
        ...
        // buttons
        $('#chkLinesVisible').click(function () {
            var checked = document.getElementById('chkLinesVisible').checked;
            treeMain.treeOptions().setLinesVisible(checked);
            /* or 
            treeMain.styles().setLine(ev.target.checked ? undefined : null);
            */
        });
        $('#btnLines1').click(function () {
            treeMain.styles().setLine('#c00,2px');
        });
        $('#btnLines2').click(function () {
            treeMain.setStyles({
                line: '#00f,1px,dashed'
            });
        });
        $('#btnLines3').click(function () {
            treeMain.loadStyles({
                grid: {
                    line: '#333,1px,dotted'
                }
        ...
        $('#btnLinesReset').click(function () {
            treeMain.styles().setLine(undefined);
        });
    });
</script>
</head>
<body>
    <h3>Tree Styles</h3>
    <input type="checkbox" id="chkLinesVisible" checked="checked">Lines Visible
    <button id="btnLines1">Line Styles 1</button>
    <button id="btnLines2">Line Styles 2</button>
    <button id="btnLines3">Line Styles 3</button>
    <button id="btnLinesReset">Reset Line Styles</button>
